...
//
//func (cb *ConsulBalancer) viperListenRules(consulAddr string) {
//	v := viper.New()
//	err := v.AddRemoteProvider("consul", consulAddr, "gateway/loadbalancer/rules")
//	if err != nil {
//		logger.Error("Failed to add consul remote provider", zap.Error(err))
//	}
//
//	v.SetConfigType("json")
//
//	if err := v.ReadRemoteConfig(); err != nil {
//		logger.Error("Failed to read consul remote provider", zap.Error(err))
//	}
//	go func() {
//		for {
...
//			if err != nil {
//				logger.Error("Failed to watch consul remote provider", zap.Error(err))
//				continue
//			}
//			var newRules map[string][]string
//			if err := v.Unmarshal(&newRules); err != nil {
//				logger.Error("Failed to unmarshal consul remote provider", zap.Error(err))
//			} else {
//				cb.mu.Lock()
//				cb.rules = newRules
//				cb.mu.Unlock()
